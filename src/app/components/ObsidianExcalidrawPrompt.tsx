 ...
 * drawing. Offers to convert it into a native Zenvoy `.excalidraw` drawing
    ...
    <div className="flex min-h-0 flex-1 items-center justify-center p-8">
      <div className="max-w-md rounded-3xl border border-paper-300/70 bg-paper-50/50 p-8 text-center shadow-[0_14px_36px_rgba(15,23,42,0.05)]">
        ...
        <p className="mt-2 text-sm leading-6 text-ink-500">
          This file is an Excalidraw drawing made with Obsidian. Convert it to a native Zenvoy
        ...
        <div className="mt-6">
          <Button
            ...
            disabled={converting}
          >
            {converting ? 'Converting…' : 'Convert to Zenvoy drawing'}
          </Button>
        </div>
