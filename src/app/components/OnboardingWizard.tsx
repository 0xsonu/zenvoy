...
import appIcon from '../assets/zenvoy-app-icon.png'
...
function BrandMark(): JSX.Element {
  return (
    <div className="pointer-events-none fixed left-6 top-16 hidden items-center gap-2 text-xs text-ink-500 md:flex">
      ...
      <span className="font-medium tracking-wide">Zenvoy</span>
    </div>
  )
}
  ...
  return (
    <div>
      <div className="flex flex-col items-center text-center">
        ...
        />
        <div className="mt-5">
          <h1 className="font-serif text-3xl font-semibold text-ink-900">Welcome to Zenvoy</h1>
  ...
  return (
    <div>
      <StepHeading
        eyebrow="Step 1"
        title="Vim mode"
        subtitle="Zenvoy is built around Vim motions — leader keys, normal/insert, gg/G, hjkl across the sidebar. You can change this any time in Settings."
      />
  ...
  return (
    <div>
      <StepHeading
        ...
        subtitle={
          isServerVaultSetup
            ? 'Pick the folder on the server that Zenvoy should treat as your vault.'
            : 'Pick a folder on this machine. Zenvoy stores notes as plain .md files — yours to keep, back up, and sync however you like.'
        }
      />
        ...
        <div>
          ...
          <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
            <ChoiceCard
              ...
              title="Inbox folder"
              description="Notes live under inbox/. Keeps Zenvoy' lifecycle structure: inbox → archive → trash."
            />
            <ChoiceCard
