...
describe('app update state labels', () => {
  it('shows attention labels for available updates', () => {
    ...
    expect(appUpdateNoticeLabel(state)).toBe('Zenvoy 1.3.10 is available')
  ...
  it('shows ready labels after an update downloads', () => {
    ...
    expect(appUpdateNoticeLabel(state)).toBe('Zenvoy 1.3.10 is ready')
  ...
  it('shows download progress while the update is downloading', () => {
    ...
    expect(appUpdateNoticeLabel(state)).toBe('Downloading Zenvoy 1.3.10')
