      ...
      run: async () => {
        ...
        if (status.installedAt && !status.installedByThisApp) {
          await confirmApp({
            ...
            description: `${status.installedAt} is not managed by Zenvoy. Remove it manually if you want Zenvoy to take over.`,
            confirmLabel: 'OK',
            cancelLabel: 'Close'
          })
          return
